...
# --- 2. Model Definition and Training (Following graphrec.py) ---
...
def train_and_recommend(args):
    print(f"\n--- Starting FANAR Model Training for: {args.pickle_name} ---")
...
def evaluate_model(args):
    print(f"\n--- Starting Evaluation for FANAR with threshold: {args.threshold} ---")
    ...
    for k in top_k_values:
        ...
        if not os.path.exists(recs_filename):
            print(f"Warning: Recommendation file not found at {recs_filename}")
            continue
...
def create_seed_files():
    """
    Creates seed files based on the generated recommendations for the FANAR model on the FakeHealth dataset.
    """
...
def main():
    parser = argparse.ArgumentParser(description='FANAR model for FakeHealth dataset.')
    parser.add_argument('--pickle_name', type=str, default='FH_Trustworthy_Neighbors_0.5_threshold.pickle', help='Name of the trust-filtered input pickle file.')
    parser.add_argument('--batch_size', type=int, default=128, metavar='N', help='input batch size for training')
    parser.add_argument('--embed_dim', type=int, default=64, metavar='N', help='embedding size')
    parser.add_argument('--lr', type=float, default=0.001, metavar='LR', help='learning rate')
    parser.add_argument('--test_batch_size', type=int, default=1000, metavar='N', help='input batch size for testing')
    parser.add_argument('--epochs', type=int, default=100, metavar='N', help='number of epochs to train')
    parser.add_argument('--threshold', type=float, default=0.5, help='Reputation threshold used for this run (for logging).')
    ...
    print("\n--- FANAR Script finished successfully! ---")

...
def prepare_union_data(threshold, neighbor_size):
    ...
    and the trustworthy neighbor graph (with a specific neighbor size).
    """
    ...
    final_pickle_path = os.path.join(PROCESSED_FILE_DIR, f"FH_Trust_Social_Union_Neighbor_{threshold}_threshold_n{neighbor_size}.pickle")
...
def train_and_recommend(args, final_pickle_path):
    ...
    for k in top_k_values:
        ...
        filename = f'{DATA_FILE_DIR}/FH_Trustworthy_Social_Union_Neighbor_{args.threshold}_threshold_n{args.neighbor_size}_top_{k}.csv'
...
def evaluate_model(threshold, neighbor_size):
    ...
    for k in top_k_values:
        ...
        recs_filename = f"{DATA_FILE_DIR}/FH_Trustworthy_Social_Union_Neighbor_{threshold}_threshold_n{neighbor_size}_top_{k}.csv"
    ...
    mrr_summary_path = os.path.join(RESULTS_DIR, f'fh_trust_union_mrr_summary_{threshold}_threshold_n{neighbor_size}.csv')
    ...
    mc_summary_path = os.path.join(RESULTS_DIR, f'fh_trust_union_mc_summary_{threshold}_threshold_n{neighbor_size}.csv')
...
def create_seed_files(threshold, neighbor_size):
    ...
    for k in top_k_values:
        ...
        seed_dir = os.path.join(SEEDS_DIR, 'trustworthy_social_union_neighbour', f'threshold_{threshold}_n{neighbor_size}', f'top_{k}')
...
def main():
    ...
    final_pickle_path = os.path.join(PROCESSED_FILE_DIR, f"FH_Trust_Social_Union_Neighbor_{args.threshold}_threshold_n{args.neighbor_size}.pickle")
